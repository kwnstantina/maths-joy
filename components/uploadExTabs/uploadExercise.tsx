...
const UploadExercise = (props:Props) => {
  const {handleSubmit,onChangeHandler,uploadData,actionData,buttonState} =props;
  return (
    <>
    ...
    <FormField
      ...
      />
   <label htmlFor="exercise" className={"block text-sm font-medium text-gray-700"}>Ανέβασμα Ασκησης:</label>
   <textarea id="exercise" name="exercise" rows={4} cols={50} onChange={onChangeHandler}>{uploadData.exercise}</textarea>
     <button
           value="upload"
