          ...
          <div className="flex flex-col space-y-24 text-center md:flex-row md:space-y-0">
            <div className="flex flex-col items-center space-y-2 md:w-1/2">
              <div className="flex items-center justify-center mb-6">
                <img
                  src={excersises}
                  className="w-60 h-60 rounded rounded-3xl shadow-md"
                  alt="Ασκήσεις Μαθηματικών"
                />
              </div>
              <h3 className="text-xl font-bold">Ασκήσεις Μαθηματικών</h3>
              <p className="max-w-md">
                Άλυτες και λυμένες ασκήσεις και πολλαπλής επιλογής για τάξεις
                γυμνασίου, λυκείου και πανεπιστήμιου.
              </p>
            </div>
        ...
        >
          <div>
            <h1 className="text-xl font-bold">
              Forum για απορίες και συζήτηση
            </h1>
            <a
              href="/chat"
              className="inline-flex mt-5 items-center justify-center p-5 bg-orange-200 text-base font-medium text-black-500 rounded-lg hover:text-gray-900 hover:bg-orange-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <span className="w-full">Forum</span>
              <svg
                aria-hidden="true"
