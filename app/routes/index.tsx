...
export default function Index() {
  ...
  return (
    <>
      ...
      <section className="w-full flex gap-10 items-start justify-evenly xs:flex-col md:flex-row bg-gray-50">
      <div  className="w-94 pl-10 pt-10" >
        ...
        >
          ...
          <Box
            ...
            additionStyle="flex items-center justify-center mb-6 h-40 md:w-[36rem]	 bg-gradient-to-r from-rose-200	 to-rose-300  rounded-3xl shadow-md"
          >
          ...
          <Box
            ...
            additionStyle="flex items-center justify-center  mb-6 h-40 md:w-[36rem]	 bg-gradient-to-r from-teal-200	 to-teal-500  rounded-3xl shadow-md"
          >
      ...
      <section className="w-10/12 mx-auto px-6 pb-32 rounded-t-md mb-6">
        ...
        >
          <div>
            <h1 className="text-xl text-center mt-10 font-black">
